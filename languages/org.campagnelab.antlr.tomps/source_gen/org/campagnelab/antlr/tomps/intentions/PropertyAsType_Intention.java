...
public class PropertyAsType_Intention implements IntentionFactory {
  ...
  public String getPersistentStateKey() {
    return "org.campagnelab.antlr.tomps.intentions.PropertyAsType_Intention";
  }
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      switch (Arrays.binarySearch(stringSwitchCases_mdn6d3_a0a0d21, myParameter)) {
        case 2:
  ...
  private static String[] stringSwitchCases_mdn6d3_a0a0d21 = new String[]{"boolean", "float", "int", "operator"};
}
