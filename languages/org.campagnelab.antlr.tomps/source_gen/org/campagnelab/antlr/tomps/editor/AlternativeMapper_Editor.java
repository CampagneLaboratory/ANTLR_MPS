...
public class AlternativeMapper_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createReadOnlyModelAccessor_cj2frz_a0(final EditorContext editorContext, final SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new AlternativeMapper_Editor.AlternativeMapper_generic_cellMenu_cj2frz_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  private EditorCell createRefNodeList_cj2frz_e0(EditorContext editorContext, SNode node) {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_CHILDREN_NEWLINE, 0, AlternativeMapper_Editor._StyleParameter_QueryFunction_cj2frz_a0e0(editorContext, node));
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, 0, true);
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, 0, AlternativeMapper_Editor._StyleParameter_QueryFunction_cj2frz_a2e0(editorContext, node));
    editorCell.getStyle().putAll(style);
  ...
  private static class mapListHandler_cj2frz_e0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      ...
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(mapListHandler_cj2frz_e0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x6a1bb02ea606232bL, 0x7c18b9e1882f807L, "map")));
      try {
    ...
    public void installElementCellActions(SNode listOwner, SNode elementNode, EditorCell elementCell, EditorContext editorContext) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementCell.getSubstituteInfo() == null || elementCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
          elementCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(myEditorContext, new SChildSubstituteInfo(elementCell, myOwnerNode, MetaAdapterFactory.getContainmentLink(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x6a1bb02ea606232bL, 0x7c18b9e1882f807L, "map"), elementNode), new DefaultChildSubstituteInfo(myOwnerNode, elementNode, super.getLinkDeclaration(), myEditorContext)));
        }
      }
    }
  }
