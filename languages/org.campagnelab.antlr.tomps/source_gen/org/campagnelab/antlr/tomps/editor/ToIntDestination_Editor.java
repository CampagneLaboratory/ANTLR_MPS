  ...
  private class toConvertSingleRoleHandler_suowx5_c0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new CompositeSubstituteInfo(myEditorContext, new AggregationCellContext(myOwnerNode, child, myContainmentLink.getDeclarationNode()), new SubstituteInfoPartExt[]{new ToIntDestination_Editor.ToIntDestination_component_cellMenu_suowx5_a0c0(), new SChildSubstituteInfoPartEx(editorCell)}));
      }
