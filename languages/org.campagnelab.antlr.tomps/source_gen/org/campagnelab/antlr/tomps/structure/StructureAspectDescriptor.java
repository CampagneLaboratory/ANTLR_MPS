...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptAlternativeMapper = new ConceptDescriptorBuilder("org.campagnelab.antlr.tomps.structure.AlternativeMapper", MetaIdFactory.conceptId(0x932d719ce93144d5L, 0x990ce115f79b5942L, 0x6a1bb02ea606232bL)).super_("jetbrains.mps.lang.core.structure.BaseConcept").super_(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).parents("jetbrains.mps.lang.core.structure.BaseConcept").parentIds(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(558881339894394990L, "id"), new ConceptDescriptorBuilder.Prop(558881339894394992L, "fullText")).properties("id", "fullText").referenceDescriptors(new ConceptDescriptorBuilder.Ref(7645898506791953297L, "alternative", MetaIdFactory.conceptId(0xd6782141eafa4cf7L, 0xa85d1229abdb1152L, 0x631eebe3113b458fL), false), new ConceptDescriptorBuilder.Ref(558881339892900180L, "returns", MetaIdFactory.conceptId(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979ba0450L), true)).references("alternative", "returns").create();
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptAlternativeMapper, myConceptConceptMapper, myConceptConvertToMPS);
  }
  ...
  private static String[] stringSwitchCases_1htk8d_a0a0h = new String[]{"org.campagnelab.antlr.tomps.structure.AlternativeMapper", "org.campagnelab.antlr.tomps.structure.ConceptMapper", "org.campagnelab.antlr.tomps.structure.ConvertToMPS"};
}
