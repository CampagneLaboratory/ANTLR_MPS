...
public class Mapper_Behavior {
  ...
  public static List<SNode> call_linkDeclarations_4068410015139836194(SNode thisNode, List<SNode> links, SNode concept) {
    do {
    ...
    do {
      ...
      ListSequence.fromList(SLinkOperations.getChildren(concept, MetaAdapterFactory.getContainmentLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979ba0450L, 0x110358d693eL, "implements"))).visitAll(new IVisitor<SNode>() {
        public void visit(SNode iconcept) {
          Mapper_Behavior.call_linkDeclarations_4068410015139836194(thisNode, links, SLinkOperations.getTarget(iconcept, MetaAdapterFactory.getReferenceLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x110356fc618L, 0x110356fe029L, "intfc")));
        }
      });
