...
public class OptionalParamEditor implements ConceptEditorComponent {
  ...
  private EditorCell createCollection_n507rx_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new OptionalParamEditor.HasOptionalParams_generic_cellMenu_n507rx_a0a(), new OptionalParamEditor.HasOptionalParams_generic_cellMenu_n507rx_b0a()}));
